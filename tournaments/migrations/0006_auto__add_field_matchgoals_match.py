...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchGoals.match'
        db.add_column(u'tournaments_matchgoals', 'match',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tournaments.Match']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchGoals.match'
        db.delete_column(u'tournaments_matchgoals', 'match_id')
