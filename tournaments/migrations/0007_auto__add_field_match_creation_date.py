...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.creation_date'
        db.add_column(u'tournaments_match', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.creation_date'
        db.delete_column(u'tournaments_match', 'creation_date')
